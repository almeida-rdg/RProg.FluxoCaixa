...
namespace RProg.FluxoCaixa.Consolidado.Infrastructure.Data
{
    ...
    {
        // Métodos específicos para a API de consultas CQRS        /// <summary>
        ...
        /// <summary>
        /// Obtém consolidados por período e tipo de consolidação para API CQRS.
        /// </summary>
        Task<IEnumerable<ConsolidadoDiario>> ObterPorPeriodoETipoAsync(DateTime dataInicial, DateTime dataFinal, string tipoConsolidacao, CancellationToken cancellationToken = default);
        ...
        /// <summary>
        /// Obtém a última data de atualização por período e tipo de consolidação para API CQRS.
        /// </summary>
        Task<DateTime?> ObterUltimaDataAtualizacaoPorTipoAsync(DateTime dataInicial, DateTime dataFinal, string tipoConsolidacao, CancellationToken cancellationToken = default);
